...
In the curriculum, it was said the class was an attempt to analyze the underlying anatomical structures of human civilization that remained the same in different ages. He explained in a lecture that the trinity of business—tech, marketing, and management in modern terms—were the driving forces behind forming a social system. He explained the Neolithic and Industrial Revolutions as two examples of critical inflection points in human history. Of course, we can identify the trinity in each transformational moment in history. I found his framework compelling. The books he recommended for future reading like Kropotkin's "The Conquest of Bread" were excellent.
