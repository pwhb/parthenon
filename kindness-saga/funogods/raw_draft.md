...
## Chapter IX - Sunset in Pink Spectrum [Science] (raw)
...
In the curriculum, it was said the class was an attempt to analyze the underlying anatomy of human civilization that remained the same in different ages. He explained in a lecture that the trinity of business that we might call tech, marketing and management in modern terms were the driving forces behind forming a social system. He explained two ages—Neolithic Revolution and Industrial Revolution—as the points of almost no return in human history. Of course, we can identify the trinity in each transformational moment in history. I found it convincing. The books he recommended for future reading like the Conquest of Bread by Peter Kropotkin were great.

But I couldn't help correcting him like I often did with Luna. Of course, I never taught Luna anything since she was a graduate student and I was just a kid that loved mathematics. I didn't have enough foundation to teach her. I only pointed at things she might have missed. I had to do the same with Professor Alexei. I explained to him that what he was trying to theorize was something I'd prefer to call Conquest. Conquest has a trinity of tools; Quantification, Temptation and Subjugation. Professor Alexei took a while to understand what I was proposing. But there was a girl in the class that decided to defend him out of nowhere. She complained that the system I proposed was essentially a rephrased version of the very system Professor Alexei proposed. Of course, it was precisely how I came up with them in the first place. But I had to explain the terms I proposed were more rigorous and precise.

Steam engine from one of the examples Professor Alexei gave could be used as an example as good as any. It was a pivotal moment in history where humans could achieve a velocity that they couldn't dream of before. Along with the velocity, more doors were opened. Transportation and colonization were implemented in a whole new different level. Professor Alexei viewed it as a symbol of technological revolution but I saw it as a consequence of function that map fuels to efficiency. So long as the value of fuel could be describe in terms of money, everything that came as a result could also be equated. I agreed with Professor Alexei about considering it as a crucial nail in the coffin of human civilization. We could quantified things that were more complicated before. He was convinced after my awkward explanation but the girl wasn't. If not for running out of time, I couldn't imagine how long the discussion might go on.
...
We arrived in Frankfurt two days ago. It would be a long story to explain why we were there. We would need to talk about a man that was already in prison first. His name was Theo Finch. He was a financier who handled the financial assets of almost all the most powerful people in the world. It wasn't even that difficult to profile him; his life story was already in the news. What was interesting was that he was the primary client of Aegis Advisory. Of course, he would never contact the firm himself. It took me a decade of black hat work to identify the lawyers who placed the final call. Again, it was Art who connected the dots and saw that all these lawyers worked for Theo Finch.
...
I had been monitoring some of the nodes in my suspect web. I'd noticed a pattern how either some of them in person or their representative seemed to have arrived in Frankfurt in the range of a week. Once we learned that some of them scheduled to attend a party at the MesseTurm penthouse, we knew we had to come here. We rented a hotel room near MesseTurm. Prior to our arrival in Frankfurt, we already identified the string quartet scheduled to perform—elites and their obsession with pretending to be civilized, huh. It wasn't that complicated to phish the concertmaster. It took me a while to select the target; a violinist who Art would replace in the event. Of course, Art made the final decision on who the target would be and how to manipulate her. I created a fake medical emergency of her family member and replaced her with Alba Rosa, Art's musician alias, whom the violinist apparently refered personally to be her replacement. While I was working on digital espionage, Art worked on embedding microphones into some of the musical instruments identical to the quartet's, ensuring a seamless swap.
